...
public class OLD_EnemyManager : MonoBehaviour, IInteractable {
    ...
    private OLD_EnemyRestrict enemyRestrict;
    private OLD_EnemyShoot enemyShoot;

	// Use this for initialization
	void Start () {

        playerTS = GameObject.FindGameObjectWithTag("Player").transform;
        enemyMove = GetComponent<OLD_EnemyMove>();
        enemyRestrict = GetComponentInChildren<OLD_EnemyRestrict>();
        enemyShoot = GetComponent<OLD_EnemyShoot>();
